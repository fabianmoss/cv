...
\section{Theses}
\subsection{PhD}
\cvitem{Title}{\emph{Transitions of Tonality: A Model-Based Corpus Study}~(2013)}
...
\cvitem{2015}{Joint supervision of interdisciplinary project of technical design undergraduate.}
...
\cvitem{2018}{Workshop ``Voice-leading schemata in theory, corpus research, and practical composition (Compose your own Chopin!)'', EPFL, Switzerland, September 18--20, 2018}
\cvitem{}{Symposium ``Archiving Intangible Cultural Heritage \& Performing Arts: A Symposium and Summer School for Living Traditions'', EPFL, Switzerland, August 6--7, 2018}
\cvitem{2017}{Workshop ``Meaning in Music: Bridging Musicological, Linguistic, and Neuroscientific Perspectives'', EPFL, Switzerland, December 4--6, 2017.}
\cvitem{}{Summer School ``Exploring Edges: An International Colloquium between the Digital Humanities, Architecture, Artistic Research, and Critical Technical Practice'', EPFL, Switzerland, July 11--14, 2017.}
...
``Introduction to Quantitative Methods for the Social Sciences'' (TUD Graduate Academy), TUD.
}
\cvitem{2012-13}{``Cognitive Neuroscience of Music'', ``Cognitive Musicology: Theoretical Foundations'', ``Cognitive Modeling'' (Uwe Seifert), University of Cologne.}
...
\cvitem{2015--2017}{Assessor in examinations, DMCL, TUD, Dresden, Germany.}
\cvitem{2015}{Co-organization of lecture series ``Systematic Musicology: Perception and Cognition of Music'', DMCL, TUD, Dresden, Germany.}
\cvitem{2013}{Co-organization of the international conference “Musical Meter in Comparative Perspective“, HfMT, Cologne, Germany}
...
\cvitem{Languages}{Python, HTML/CSS}
\cvitem{Utilities}{Anaconda, Git, Jupyter Notebook, LaTeX}
\cvitem{Communication}{German (native), English (fluent), French, Spanish (basic)}
...
\cvitem{Instruments}{Guitar (since 1994), Piano (since 1993)}
