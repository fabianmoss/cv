...
\cvitem{in preparation}{Viaccoz, C., Harasim, D., \textbf{Moss, F. C.}, \& Rohrmeier, M. Wavescapes: A Visual Hierarchical Analysis of Tonality Using the Discrete Fourier Transformation.}
\cvitem{}{\textbf{Moss, F. C.}, Noll, T., \& Rohrmeier, M. Surfing the Chromatic Waves: Detecting \emph{Tone Fields} Using Discrete Fourier Analysis.}
...
% \cvitem{2020}{Graduate Seminar ``Introduction to Computational Musicology'', University of Cologne.}
\cvitem{2020}{Teaching Assistant, ``Musical improvisation, invention and creativity'', EPFL.}
