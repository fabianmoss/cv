...
%% In Press
\mycvitem{forthcoming}{\OA \textbf{Moss, F. C.} \& Neuwirth, M. (forthcoming). FAIR, Open, Linked: Introducing the Special Issue on Open Science in Musicology. \emph{Empirical Musicology Review}, 16(1).}
...
%% Accepted
\mycvitem{accepted}{\OA Viaccoz, C., Harasim, D., \textbf{Moss, F. C.}, \& Rohrmeier, M. (accepted). Wavescapes: A Visual Hierarchical Analysis of Tonality Using the Discrete Fourier Transformation. \emph{Musicae Scientiae}.}
...
% \mycvitem{}{Anzuoni, E., Ayhan, S., Dutto, F., McLeod, A., \textbf{Moss, F. C.}, \& Rohrmeier, M. \emph{A Historical Analysis of Harmonic Progressions Using Chord Embeddings}. Sound and Music Computing Conference [online].}
