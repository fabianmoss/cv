...
\mycvitem{MA}{\textbf{Moss, F. C.} (2012). \emph{``Theorie der Tonfelder'' nach Simon und ``Neo-Riemannian Theory'':
        Systematik, historische Bez{\"u}ge und analytische Praxis im Vergleich}. Supervisor: Hans Neuhoff}
...
%% In Review
% \mycvitem{in review}{\OA Viaccoz, C., Harasim, D., \textbf{Moss, F. C.}, \& Rohrmeier, M. (in review). Wavescapes: A Visual Hierarchical Analysis of Tonality Using the Discrete Fourier Transformation.}
% \mycvitem{}{\textbf{Moss, F. C.} \& Rohrmeier, M. Discovering tonal structures with Latent Dirichlet Allocation. \emph{Music \& Science}.}

%% Accepted

%% In Preparation
% \mycvitem{in prep.}{\textbf{Moss, F. C.} \& Rohrmeier, M. The line of fifths and the co-evolution of tonal pitch-classes. \emph{Music Theory Spectrum}.}
% \mycvitem{}{\textbf{Moss, F. C.}, Herff, S., \& Rohrmeier, M. Modeling perceived tonal stability of individual and aggregated listener responses. \emph{Music Perception: An Interdisciplinary Journal.}}
% \mycvitem{}{\textbf{Moss, F. C.}, Herff, S., \& Rohrmeier, M. Individual perception of diatonic scales predicts perceived tonal fit in extended tonality. \emph{Psychonomic Bulletin \& Review}.}
% \mycvitem{}{\OA \textbf{Moss, F. C.}, Noll, T., \& Rohrmeier, M. Surfing the Chromatic Waves: Detecting Tone Fields Using Discrete Fourier Analysis.}
% \mycvitem{}{\textbf{Moss, F. C.}, Lieck, R., \& Rohrmeier, M. Tracing Historical Changes in Tonality with the Tonal Diffusion Model.}

%% 2021
\mycvitem{2021}{\OA Harasim, D., \textbf{Moss, F. C.}, Ramirez, M., \& Rohrmeier, M. (2020). Exploring the foundations of tonality: Statistical cognitive modeling of modes in the history of Western classical music. \emph{Humanities and Social Sciences Communications}, 8(5), 1--11. \url{https://doi.org/10.1057/s41599-020-00678-6}}
...
\mycvitem{2021}{Winter School ``Digitale Editionen - Masterclass''. Bergische Universität Wuppertal, Wuppertal, Germany, 22--26 January [online].}
