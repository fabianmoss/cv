...
\cvitem{Journals}{
    ...
    \emph{Transactions of the International Society for Music Information Retrieval} (TISMIR)
    .}
\cvitem{Conferences}{\emph{International Conference of Students of Systematic Musicology} (SysMus).}
