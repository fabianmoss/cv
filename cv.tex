...
%% Submitted
\mycvitem{submitted}{\OA \textbf{Moss, F. C.}, \& Rohrmeier, M. (submitted). Discovering Tonal Profiles Using Latent Dirichlet Allocation.}
\mycvitem{}{\OA \textbf{Moss, F. C.}, \& Rohrmeier, M. (submitted). The Line of Fifths and the Co-Evolution of Tonal Pitch-Classes.}

%% In Review
\mycvitem{in review}{\OA Harasim, D., \textbf{Moss, F. C.}, Ramirez, M., \& Rohrmeier, M. (in review). Exploring the foundations of tonality: Statistical cognitive modeling of modes in the history of Western classical music.}
\mycvitem{}{\OA Viaccoz, C., Harasim, D., \textbf{Moss, F. C.}, \& Rohrmeier, M. (in review). Wavescapes: A Visual Hierarchical Analysis of Tonality Using the Discrete Fourier Transformation.}
...
%% 2019
\mycvitem{2019}{\OA \textbf{Moss, F. C.} (2019). \emph{{Transitions of {Tonality}: {A} {Model}-{Based} {Corpus} {Study}}}. Doctoral dissertation. École Polytechnique Fédérale de Lausanne, Lausanne, Switzerland. \url{https://doi.org/10.5075/epfl-thesis-9808}}
\mycvitem{}{\OA \textbf{Moss, F. C.}, Neuwirth, M., Harasim, D., \& Rohrmeier, M. (2019). Statistical characteristics of tonal harmony: A corpus study of Beethoven's string quartets. \emph{PLOS ONE}, 14(6), e0217242. \url{https://doi.org/10.1371/journal.pone.0217242}}
...
\mycvitem{}{\textbf{Moss, F. C.} \emph{Tracing the History of Tonality with Note Distributions}. ``Corpus Research as a Means of Unlocking Musical Grammar'' International Research Workshop, July 1--4, 2019, Tel-Aviv, Israel.}
...
\mycvitem{}{\textbf{Moss, F. C.} \emph{Corpus Research in Digital Musicology}. Seminar ``Willkommen in der Matrix: Digitale Anwendungen f{\"u}r die Musikanalyse in Theorie und Praxis'', University of Basel, Basel, Switzerland.}
...
\mycvitem{2020}{Workshop ``Musikalische Schrift und Digitalität'', Basel, Switzerland, September 22--23.}
