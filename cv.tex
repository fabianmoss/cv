...
%% Accepted
\mycvitem{accepted}{\OA Harasim, D., \textbf{Moss, F. C.}, Ramirez, M., \& Rohrmeier, M. (accepted). Exploring the foundations of tonality: Statistical cognitive modeling of modes in the history of Western classical music.}
...
\mycvitem{}{``Empirical Approaches to Music History'', lecture in ``Ringvorlesung Musikwissenschaft'', UzK.}
