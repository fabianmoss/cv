...
\subsection{Postdoctoral researcher supervision}

\mycvitem{2025/04--present}{Mauro Orsini Windholz: ``Computational Analysis of Brazilian Choro'', \url{https://fabianmoss.github.io/choro/}.}
\mycvitem{2025/09--present}{Adrian Nagel: ``Musico Pratico''.}

\subsection{PhD thesis supervision and examination}

\mycvitem{2027--2030}{Julius Loth Sanga: ``The Influence of \emph{Muziki Wa Dansi} to other Music Genres in Tanzania: a Comparative Analysis of \emph{taarab}, \emph{bongo flava}, \emph{muziki wa injili}, and Traditional Music Genres'' (Ethnomusicology), JMU (1st supervisor: Juniper Hill)}
\mycvitem{2026/10--today}{Pascal Schmolenzky: ``Extending Musicological Analysis with Coarse-Scale Computational Perspectives'' (Digital Humanities), JMU (1st supervisor: Christof Weiß).}
\mycvitem{2026/08}{Examiner for Cameron Anderson: ``Rethinking Emotional Communication through Musical Structure and Interpretation'' (Psychology, Neuroscience \& Behavior), McMaster University, Canda (1st Supervisor Michael Schulz)}
\mycvitem{2025/04--present}{Silas Bischoff: ``Aufstieg und Fall der Deutschen Lautentabulatur -- Eine Untersuchung zu ihrem Ursprung und zu ihrer Entwicklungsgeschichte'' (Musicology), JMU (1st supervisor: Ulrich Konrad)} % 2024--today
\mycvitem{2023/10--present}{Adrian Nachtwey: 
...
\mycvitem{2023/01--present}{Tim Eipert: ``A Quantitative Perspective on Transmission, Structure, and Modality of Medieval Chant'', Graduate School Humanities (Digital Humanities), JMU}
...
\mycvitem{2021/07--2026/03}{Shuxin Meng: ``Mapping the Structure of Chinese Folk Songs: From Corpus Analysis to Cross-Cultural Listening'', Digital Humanities, EPFL (1st supervisor: Martin Rohrmeier)} % 07/2022--today
...
\subsection{Master thesis supervision and examination}
% \mycvitem{Spring 2026}{Angelina Tarlovskaya}
\mycvitem{Spring 2026}{Christina Nastos: ``Musikalischer Ausdruck von Identität: Aloys Fleischmanns Wirken in Musik und Kulturleben'' (Musicology \& Ethnomusicology), JMU}
...
\subsection{Bachelor thesis supervsion and examination}
