...
\textbf{05/2026--present} Editorial board of \emph{Music \& Science} (SAGE)
...
\textbf{2020--2026} Co-Chair of the Music Analysis Interest Group of the \emph{Music Encoding Initiative} (MEI);
...
\textbf{10/2013--2026} Arbeitsgemeinschaft für Rheinische Musikgeschichte

\subsection{Reviewer activity}

\mycvitem{Journals}{
    \emph{Brazilian Journal of Music and Mathematics};
...
\mycvitem{Conferences}{
    ...
    \emph{European Music Analysis Conference (EuroMAC)};
...
\mycvitem{Funders}{
    ...
    \emph{Österreichischer Wissenschaftsfond (FWF)};
    \emph{Social Sciences and Humanities Research Council of Canada (SSHRC)};
    \emph{Research Council of Norway (RCN)};
    \emph{Arts and Humanities Research Council (AHRC) UK Research and Innovation (UKRI)}
  }
