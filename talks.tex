...
\mycvitem{2023}{Yust, J., Affatato, G., \& \textbf{Moss, F. C.}. \emph{Animated Harmonic Analysis Using DFT Phase Spaces and Coefficient Products}. Joint Annual Meeting of the American Musicological Society (AMS) and the Society for Music Theory (SMT), 9--12 November 2023, Denver, Colorado.}
...
\mycvitem{}{Eipert, T., Frieler, K., \& \textbf{Moss, F. C.} \emph{Inside or Outside: The Use of Chord, Scale and Chromatic Tones in Jazz Solo Improvisations}. Jahrestagung der Gesellschaft für Musikforschung, 4--7 October, 2023, Saarbrücken, Germany.}
