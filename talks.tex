...
%% 2022
\mycvitem{2022}{\inv \textbf{Moss, F. C.} \emph{Interactive Music Analysis using the DFT and Pitch-Class Distributions extracted from MIDI files}. 4 April 2022, Faculdade de Engenharia da Universidade do Porto (FEUP), Porto, Portugal.}
